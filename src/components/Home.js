...
export default function Home(){
    return (
        <main className="h-100px">
            ...
            <div className=" relative flex justify-center pt-12 sm:pt-24 xl:pt-12 lg:pt-48 md:pt-36 px-8">
            ...
            <div className=" relative flex justify-center pt-12 xl:pt-16 lg:pt-40 md:pt-8 px-8">
